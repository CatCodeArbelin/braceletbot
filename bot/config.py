    ...
    "bracelets": [
        {
            ...
            "description": (
                "Жемчуг и алмазная крошка создают мягкое сияние и благородный акцент.\n"
                "Деликатный акцент голубики добавляет глубину оттенка и свежесть образу.\n"
                "Цветок тюльпана подчеркивает женственность и легкость украшения.\n"
                "Тип замка: Тоггл."
            ),
        },
        {
            ...
            "description": (
                "Сочетание жемчуга и алмазной крошки делает браслет сияющим и нарядным.\n"
                "Ягодный акцент голубики придает композиции выразительность и характер.\n"
                "Тюльпан в центре композиции добавляет романтичное настроение.\n"
                "Тип замка: Карабин."
            ),
        },
        {
            ...
            "description": (
                "Нежный жемчуг в сочетании с алмазной крошкой красиво играет на свету.\n"
                "Деталь голубики добавляет свежий акцент и делает дизайн необычным.\n"
                "Декор тюльпана завершает образ и подчеркивает утонченность браслета.\n"
                "Тип замка: Карабин."
            ),
        },
    ],
